...
% Trên Overleaf: Menu → Settings → Compiler → XeLaTeX (BẮT BUỘC — không dùng pdfLaTeX)
...
\include{chapters/01-mo-dau}
\include{chapters/02-co-so-ly-thuyet}
\include{chapters/03-phan-tich-thiet-ke}
\include{chapters/04-thuc-hien-va-ket-qua}
\include{chapters/05-ket-luan}
