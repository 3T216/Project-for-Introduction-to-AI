...
\begin{enumerate}
  ...
  \item \textbf{Data quality issue:} Một số ga tên chỉ là số (ví dụ \textquotedbl 1\textquotedbl, \textquotedbl 2\textquotedbl) do OSM relation thiếu tag \texttt{name}. Một số ga có typo (ví dụ \textquotedbl National Exhibiation\textquotedbl\ thay vì \textquotedbl Exhibition\textquotedbl).
