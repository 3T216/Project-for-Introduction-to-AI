...
def greedy_best_first_search(
    ...
    # Use heuristic h(n) as priority
    # Early-exit when goal is popped from queue
    pass
\end{lstlisting}
...
\begin{itemize}
  ...
  \item Contrast AA trên body text (\#14181c trên \#ffffff $\sim$ 17:1).
