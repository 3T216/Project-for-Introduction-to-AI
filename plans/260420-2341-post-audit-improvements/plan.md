...
| 09 | [Collapsible map filter popover — thay panel inline bằng nút + dropdown](phase-09-collapsible-map-filter-popover.md) | **P0** | `web/app.js`, `web/index.html`, `web/styles.css` | 45 min |
